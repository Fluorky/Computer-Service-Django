...
class ServiceRequestListView(View):
    def get(self, request):
        ...
        return render(request, 'computerserviceapp/lists/service_request_list.html',
...
class ServiceRequestDetailView(View):
    def get(self, request, pk):
        ...
        return render(request, 'computerserviceapp/details/service_request_detail.html',
...
class ServiceRequestDeleteView(View):
    def get(self, request, pk):
        service_request = get_object_or_404(ServiceRequest, pk=pk)
        return render(request, 'computerserviceapp/delete/service_request_confirm_delete.html',
                      {'service_request': service_request})
...
def service_technician_list(request):
    ...
    return render(request, 'computerserviceapp/lists/service_technician_list.html',
...
def service_technician_detail(request, pk):
    ...
    return render(request, 'computerserviceapp/details/service_technician_detail.html',
...
def service_technician_delete(request, pk):
    ...
    return render(request, 'computerserviceapp/delete/service_technician_confirm_delete.html',
                  {'service_technician': service_technician})
